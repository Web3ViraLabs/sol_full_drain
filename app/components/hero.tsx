      ...
      <div className="relative px-4 sm:px-0">
        ...
        <div className="relative grid mx-auto overflow-hidden  divide-y rounded shadow sm:divide-y-0 sm:divide-x sm:max-w-screen-sm sm:grid-cols-3 lg:max-w-screen-md">
          <div className="inline-block p-8 text-center">
            <div className="flex items-center justify-center w-12 h-12 mx-auto mb-4 rounded-full bg-zinc-600">
              <svg
            ...
            <p className="font-bold tracking-wide ">Make it better</p>
          </div>
          <div className="inline-block p-8 text-center">
            <div className="flex items-center justify-center w-12 h-12 mx-auto mb-4 rounded-full bg-zinc-600">
              <svg
            ...
            <p className="font-bold tracking-wide ">Do it faster</p>
          </div>
          <div className="inline-block p-8 text-center">
            <div className="flex items-center justify-center w-12 h-12 mx-auto mb-4 rounded-full bg-zinc-600">
              <svg
            ...
            <p className="font-bold tracking-wide ">Working harder</p>
          </div>
        </div>
      </div>
    </div>
